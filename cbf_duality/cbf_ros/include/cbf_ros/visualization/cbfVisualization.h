...
class cbfVisualization : public DummyObserver {
 public:
  ...
  */
  cbfVisualization(PinocchioInterface pinocchioInterface, CentroidalModelInfo centroidalModelInfo,
                        const PinocchioEndEffectorKinematics& endEffectorKinematics, ros::NodeHandle& nodeHandle,
                        scalar_t maxUpdateFrequency = 100.0);
  ~cbfVisualization() override = default;
 ...
 private:
  private:
  cbfVisualization(const cbfVisualization&) = delete;
