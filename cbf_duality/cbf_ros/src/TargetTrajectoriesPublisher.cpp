...
#include "cbf_ros/TargetTrajectoriesPublisher.h"
...
int main(int argc, char** argv) {
  std::cout << "Trajectories pub main step 1" << std::endl;
  const std::string robotName = "legged_robot";

  // Initialize ros node
  std::cout << "Trajectories pub main step 2" << std::endl;
  ...
  std::cout << "Trajectories pub main step 4" << std::endl;
  TargetTrajectoriesPublisher target_pose_command(nodeHandle, robotName, &goalToTargetTrajectories, &cmdVelToTargetTrajectories);
  std::cout << "Trajectories pub main step 5" << std::endl;
  ros::spin();
  std::cout << "Trajectories pub main step 6" << std::endl;
  // Successful exit
  return 0;
}
